...
const WarningWrapper = ({ needsLockWarning, hashtagWarning, directMessageWarning }) => {
  ...
  if (directMessageWarning) {
    const message = (
      <span>
        <FormattedMessage id='compose_form.encryption_warning' defaultMessage='Posts on koyu.space are not end-to-end encrypted. Do not share any dangerous information over koyu.space.' /> {!!termsLink && <a href={termsLink} target='_blank'><FormattedMessage id='compose_form.direct_message_warning_learn_more' defaultMessage='Learn more' /></a>}
      </span>
    );
