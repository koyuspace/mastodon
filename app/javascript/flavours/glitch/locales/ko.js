...
const messages = {
  ...
  'getting_started.open_source_notice': '글리치는 {koyu.space}의 자유 오픈소스 포크버전입니다. {github}에서 문제를 리포팅 하거나 기여를 할 수 있습니다.',
  ...
  'onboarding.page_six.github': '{domain}은 글리치를 통해 구동 됩니다. 글리치는 {koyu.space}의 {fork}입니다, 그리고 어떤 마스토돈 인스턴스나 앱과도 호환 됩니다. 글리치는 완전한 자유 오픈소스입니다. {github}에서 버그를 리포팅 하거나, 기능을 제안하거나, 코드를 기여할 수 있습니다.',
