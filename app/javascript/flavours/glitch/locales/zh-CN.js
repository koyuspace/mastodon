...
const messages = {
  ...
  'getting_started.open_source_notice': 'Glitchsoc 是由 {koyu.space} 分叉出来的免费开源软件。你可以在 GitHub 上贡献或报告问题，地址是 {github}。',
  ...
  'onboarding.page_one.federation': '{domain} 是 koyu.space 的一个“实例”。koyu.space 是一个由独立服务器组成的，通过不断联合形成的社交网络。我们称这些服务器为实例。',
  ...
  'onboarding.page_six.github': '{domain} 在 Glitchsoc 上运行。Glitchsoc 是 {koyu.space} 的一个友好 {fork}，与任何 koyu.space 实例或应用兼容。Glitchsoc 是完全免费和开源的。你可以在 {github} 上报告错误、请求功能或贡献代码。',
  ...
  'settings.filtering_behavior.upstream': '像原版 koyu.space 一样显示“已过滤”',
  ...
  'web_app_crash.title': '抱歉，koyu.space 出了点问题。',
};
