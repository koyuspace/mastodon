...
const messages = {
  ...
  'getting_started.open_source_notice': 'Glitchsoc es software libre y gratuito bifurcado de {koyu.space}. Puedes contribuir o reportar errores en GitHub en {github}.',
  ...
  'onboarding.page_one.federation': '{domain} es una "instancia" de koyu.space. koyu.space es una red de servidores independientes que se unen para crear una red social más grande. A estos servidores los llamamos instancias.',
  'onboarding.page_one.welcome': '¡Bienvenidx a {domain}!',
  'onboarding.page_six.github': '{domain} usa Glitchsoc. Glitchsoc es una bifurcación {fork} amigable de {koyu.space}, y es compatible con cualquier instancia o aplicación de koyu.space. Glitchsoc es completamente gratuito y de código abierto. Puedes reportar errores, solicitar funciones o contribuir al código en {github}.',
