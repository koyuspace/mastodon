...
const messages = {
  ...
  'onboarding.page_one.federation': '{domain} is an \'instance\' of koyu.space. koyu.space is a network of independent servers joining up to make one larger social network. We call these servers instances.',
  'onboarding.page_one.welcome': 'Welcome to {domain}!',
  'onboarding.page_six.github': '{domain} runs on Glitchsoc. Glitchsoc is a friendly {fork} of {koyu.space}, and is compatible with any koyu.space instance or app. Glitchsoc is entirely free and open-source. You can report bugs, request features, or contribute to the code on {github}.',
